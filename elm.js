...
var _user$project$Areas$baseUrl = {name: 'http://127.0.0.1:8080/'};
...
var _user$project$Job$postJob = function (model) {
	...
	var url = 'http://127.0.0.1:8080/jobs';
...
var _user$project$SalariesChart$chart = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$width('auto'),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$height('auto'),
				_1: {
					ctor: '::',
...
var _user$project$SalariesChart$getSalaries = function () {
	var url = 'http://127.0.0.1:8080/salaries';
...
var Elm = {};
Elm['Areas'] = Elm['Areas'] || {};
if (typeof _user$project$Areas$main !== 'undefined') {
    _user$project$Areas$main(Elm['Areas'], 'Areas', undefined);
}
Elm['Job'] = Elm['Job'] || {};
if (typeof _user$project$Job$main !== 'undefined') {
    _user$project$Job$main(Elm['Job'], 'Job', undefined);
}
Elm['SalariesChart'] = Elm['SalariesChart'] || {};
if (typeof _user$project$SalariesChart$main !== 'undefined') {
    _user$project$SalariesChart$main(Elm['SalariesChart'], 'SalariesChart', undefined);
}
